...
print("a=",a)
print("d=",d)
#Noto que se corresponde en forma y tamaño, también en el tipo de los valores, tratándose de floats.
...
print(c)
print("e==a:",e==a)
#Sí son iguales debido a la propiedad de las matrices en la multiplicación de c por a ya que c es una matriz de 1'os.
